[![Download the latest release](docs/img/download-button.png)](https://raw.githubusercontent.com/peter88213/scap_novx/main/dist/scap_novx_v5.4.2.pyz)
...
Download the latest release [scap_novx_v5.4.2.pyz](https://github.com/peter88213/scap_novx/raw/main/dist/scap_novx_v5.4.2.pyz)

- Launch *scap_novx_v5.4.2.pyz* by double-clicking (Windows/Linux desktop),
- or execute `python scap_novx_v5.4.2.pyz` (Windows), resp. `python3 scap_novx_v5.4.2.pyz` (Linux) on the command line.
...
The package is also available in zip format: [scap_novx_v5.4.2.zip](https://github.com/peter88213/scap_novx/raw/main/dist/scap_novx_v5.4.2.zip)

- Extract the *scap_novx_v5.4.2* folder from the downloaded zipfile "scap_novx_v5.4.2.zip".
