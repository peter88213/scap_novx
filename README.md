[![Download the latest release](docs/img/download-button.png)](https://raw.githubusercontent.com/peter88213/scap_novx/main/dist/scap_novx_v2.2.3.pyzw)
...
Download the latest release [scap_novx_v2.2.3.pyzw](https://github.com/peter88213/scap_novx/raw/main/dist/scap_novx_v2.2.3.pyzw)

- Launch *scap_novx_v2.2.3.pyzw* by double-clicking (Windows/Linux desktop),
- or execute `python scap_novx_v2.2.3.pyzw` (Windows), resp. `python3 scap_novx_v2.2.3.pyzw` (Linux) on the command line.
...
The package is also available in zip format: [scap_novx_v2.2.3.zip](https://github.com/peter88213/scap_novx/raw/main/dist/scap_novx_v2.2.3.zip)

- Extract the *scap_novx_v2.2.3* folder from the downloaded zipfile "scap_novx_v2.2.3.zip".
