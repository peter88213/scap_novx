[![Download the latest release](docs/img/download-button.png)](https://raw.githubusercontent.com/peter88213/scap_novx/main/dist/scap_novx_v$Version.pyz)
...
Download the latest release [scap_novx_v$Version.pyz](https://github.com/peter88213/scap_novx/raw/main/dist/scap_novx_v$Version.pyz) ($PyzSize)

- Launch *scap_novx_v$Version.pyz* by double-clicking (Windows desktop),
- or execute `python scap_novx_v$Version.pyz` (Windows), resp. `python3 scap_novx_v$Version.pyz` (Linux) on the command line.
...
The package is also available in zip format: [scap_novx_v$Version.zip](https://github.com/peter88213/scap_novx/raw/main/dist/scap_novx_v$Version.zip) ($ZipSize)

- Extract the *scap_novx_v$Version* folder from the downloaded zipfile "scap_novx_v$Version.zip".
